...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        RegisterFirstNTextField.setText("jTextField1");
        jPanel1.add(RegisterFirstNTextField);
        RegisterFirstNTextField.setBounds(90, 230, 240, 60);

        RegisterLTextField.setText("jTextField1");
        jPanel1.add(RegisterLTextField);
        RegisterLTextField.setBounds(360, 230, 240, 60);

        RegisterUserNTextField.setText("jTextField1");
        jPanel1.add(RegisterUserNTextField);
        RegisterUserNTextField.setBounds(90, 330, 510, 60);

        RegisterPassTextField.setText("jPasswordField1");
        jPanel1.add(RegisterPassTextField);
        RegisterPassTextField.setBounds(90, 430, 510, 50);

        RegisterConfirmPTextField.setText("jPasswordField1");
        jPanel1.add(RegisterConfirmPTextField);
        RegisterConfirmPTextField.setBounds(90, 530, 510, 50);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\halla\\Desktop\\Register.png")); // NOI18N
